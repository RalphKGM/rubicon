...
public class SetIsVisibleCommand implements Command {
    private final AppService appService;
    private final DrawingAppService underlyingService; 
    private final boolean prevValue;
    private final boolean newValue;

    public SetIsVisibleCommand(AppService appService, boolean prevValue, boolean newValue) {
    ...
    public void execute() {
        ...
        if (underlyingService != null) {
            underlyingService.setIsVisible(newValue);
        } else {
    ...
    public void undo() {
        ...
        if (underlyingService != null) {
            underlyingService.setIsVisible(prevValue);
        } else {
            appService.setIsVisible(prevValue);
        }
    }
